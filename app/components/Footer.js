...
const Footer = () => {
    ...
    return (
        <footer className="bg-gray-200   dark:bg-gray-900 text-black dark:text-white">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 py-12">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <div className="flex space-x-4">
                            <Link href="https://github.com/Welderufael-Haile" target="_blank" rel="noopener noreferrer"
                            ...
                            <Link href="https://www.linkedin.com/in/welderufael-haile-4797962a9/" target="_blank" rel="noopener noreferrer"
                                className="hover:text-white transition duration-300">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                    <path 
                                        d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"
                                        className="text-[#0077b5] hover:text-[#005983]"
                                    />
                                </svg>
                            </Link>
                            <Link href="https://facebook.com" target="_blank" rel="noopener noreferrer"
                                ...
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                    <path 
                                        ...
                                        className="text-[#1877f3] hover:text-[#145db2]"
                                    />
                                </svg>
                            </Link>
                            <Link href="https://well-profile.vercel.app/" target="_blank" rel="noopener noreferrer"
                                className="hover:text-white transition duration-300">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                    <circle cx="12" cy="12" r="10" className="text-[#6366f1]"/>
                                    <path d="M12 6a6 6 0 100 12A6 6 0 0012 6zm0 2a4 4 0 110 8 4 4 0 010-8z" className="text-white"/>
                                </svg>
                            </Link>
                        </div>
                    </div>
